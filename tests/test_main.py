...
@patch('src.article_manager.ArticleManager')
@patch('src.plugin_loader.load_plugins')
def test_main_flow_new_articles_found(
    mock_load_plugins, mock_article_manager, mock_config_manager_class, mock_load_config
):
    ...
    # --- Assert ---
    mock_am_instance.get_latest_articles.assert_called()
    mock_am_instance.load_saved_articles.assert_called()
    mock_am_instance.get_new_articles.assert_called()
    assert mock_am_instance.create_post_text.called
    mock_load_plugins.assert_called()
    assert mock_plugin.post.called
    mock_am_instance.save_articles.assert_called()

@patch('src.config_manager.load_config')
@patch('src.config_manager.ConfigManager')
@patch('src.article_manager.ArticleManager')
@patch('builtins.print')
def test_main_flow_no_new_articles(mock_print, mock_article_manager, mock_config_manager_class, mock_load_config):
...
def test_main_touch_rss_posted_calls_article_manager_method(
    mock_print, mock_article_manager, mock_config_manager_class, mock_load_config
):
...
@patch('src.article_manager.ArticleManager')
@patch('builtins.print')
def test_touch_rss_posted_prints_feedback(mock_print, mock_article_manager, mock_config_manager_class, mock_load_config):
...
@patch('src.article_manager.ArticleManager')
@patch('builtins.print')
def test_touch_rss_posted_dry_run(mock_print, mock_article_manager, mock_config_manager_class, mock_load_config):
