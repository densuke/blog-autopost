...
@pytest.fixture
def post_executor(mock_scheduled_post_store, mock_config_manager, mock_core_posting_logic):
    """
    PostExecutorのインスタンスを作成します。
    """
    return PostExecutor(mock_scheduled_post_store, mock_config_manager, mock_core_posting_logic)
