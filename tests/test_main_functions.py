...
from src.cli.media_handler import (
    extract_image_from_url,
    process_media_files,
)
from src.cli.post_handler import (
    handle_list_sns,
...
from src.cli.feed_handler import (
    handle_list_feeds,
...
@patch('src.cli.media_handler.requests.get')
...
@patch('src.cli.post_handler.execute_sns_posting')
@patch('src.cli.post_handler.validate_and_filter_plugins')
@patch('src.cli.post_handler.setup_text_optimization')
@patch('src.cli.post_handler.process_media_files')
...
@patch('src.cli.post_handler.handle_list_sns')
...
@patch('src.config_manager.load_config')
@patch('src.cli.feed_handler.handle_list_feeds')
...
@patch('src.config_manager.load_config')
@patch('src.cli.post_handler.handle_direct_text_post')
...
@patch('src.config_manager.load_config')
@patch('src.config_manager.ConfigManager')
@patch('src.article_manager.MultiArticleManager')
